...
_G.packer_plugins = {
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/ali/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["neovim-ayu"] = {
    loaded = true,
    path = "/home/ali/.local/share/nvim/site/pack/packer/start/neovim-ayu",
  ...
  ripgrep = {
    loaded = true,
    path = "/home/ali/.local/share/nvim/site/pack/packer/start/ripgrep",
